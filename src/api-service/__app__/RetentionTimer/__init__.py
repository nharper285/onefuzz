...
def main(mytimer: func.TimerRequest) -> None:
    ...
    for job in Job.search():
        ...
        if job_timestamp < (
            ...
            logging.info("Found job %s older than 18 months. Scrubbing user_info.", job.job_id)
    ...
    for task in Task.search():
        ...
        if task_timestamp < (
            ...
            logging.info("Found task %s older than 18 months. Scrubbing user_info.", task.task_id)
